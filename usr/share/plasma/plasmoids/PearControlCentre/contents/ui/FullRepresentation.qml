...
Item {
    ...
    // For Dialog (when not in Layout) - use fixed height from parent
    ...
    property bool expanded: root.isOpen
    ...
    SequentialAnimation  {
        ...
        ParallelAnimation {
            ...
            PropertyAnimation { target: fullRep; property: "width"; to: newWidth; duration: 50 }
            PropertyAnimation { target: fullRep; property: "height"; to: newHeight; duration: 50 }
        }
