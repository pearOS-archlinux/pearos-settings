...
PageTemplate {
    ...
    onInhibitionChangeRequested: inhibit => {
        ...
        inhibitionControl.isSilent = root.isOpen; // show OSD only when the plasmoid isn't expanded since the changing switch is feedback enough
    ...
    onActivateProfileRequested: profile => {
        powerProfilesControl.isSilent = root.isOpen;
