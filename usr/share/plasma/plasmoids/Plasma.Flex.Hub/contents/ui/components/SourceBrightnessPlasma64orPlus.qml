...
Item {
    ...
    property bool nightModeA: Plasmoid.configuration.nightMode
    ...
    onRealValueSliderChanged: {
        ...
        screenBrightnessControl.setBrightness(mainScreen.displayName, Math.max(brightnessMin, Math.min(mainScreen.maxBrightness, (realValueSlider*100)))) ;
    }
