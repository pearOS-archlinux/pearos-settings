...
Kirigami.ScrollablePage {
    ...
    readonly property alias cfg_noActivityText: noActivityText.text
    ...
    Kirigami.FormLayout {
        ...
        RowLayout {
            Kirigami.FormData.label: i18n("When no activity:")
            PC3.TextField {
                id: noActivityText
                text: "Pinder"
            }
            PC3.ToolButton {
                icon.name: "documentinfo"
                PC3.ToolTip {
                    text: i18n("Text to display when no application is running. If set to 'Pinder', will show 'Pinder' (bold) + ' Operating System' (non bold) + menu buttons (File, Edit, View, Go, Window, Help).")
                }
            }
        }
        Kirigami.Separator {
